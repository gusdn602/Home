...
<style>
body{
	background-image: url("../img/dublin-2344423_1920.jpg");
}
.h_logo{
...
<div>
	...
	<!-- header -->
	<div id="header">
		<h1><a href="http://www.naver.com/" class="sp h_logo"></a></h1>
	</div>
	<!-- //header -->
	<!-- container -->
	<div id="container">
		...
		<div id="content">
			...
			<!-- 아이디, 비번, 회원가입-->
				<div class="find_info">
					<a target="_blank" id="idinquiry" >아이디 찾기</a> <span class="bar" aria-hidden="true">|</span> <a target="_blank" id="pwinquiry">비밀번호 찾기</a> <span class="bar" aria-hidden="true">|</span> <a target="_blank" id="join">회원가입</a>
				</div>
		</div>
		<!-- //content -->
	</div>
