...
<div>
	...
	<div id="container">
		...
		<div id="content">
			...
			<!-- 아이디, 비번, 회원가입-->
				<div class="find_info">
					<a target="_blank" id="idinquiry" >아이디찾기</a> <span class="bar" aria-hidden="true">|</span> <a target="_blank" id="pwinquiry">비밀번호찾기</a> <span class="bar" aria-hidden="true">|</span> <a target="_blank" id="join">회원가입</a>
				</div>
		</div>
		<!-- //content -->
	</div>
